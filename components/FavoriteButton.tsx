    ...
    <>
      {!showProduct ? (
        <Link href="/wishlist" className="group relative">
          ...
          <span className="absolute -top-1 -right-1 bg-shop_btn_dark_green text-white w-3.5 h-3.5 rounded-full text-xs font-semibold flex items-center justify-center">
            0
          </span>
        </Link>
      ) : (
